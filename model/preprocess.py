...
import joblib
from core.features import (TARGET,
                           NUMERIC_FEATURES,
...
data_transformer = ColumnTransformer(transformers=[
    ...
    ('bin_cat_features', OneHotEncoder(drop='first', handle_unknown='ignore', sparse_output=False), BINARY_CATEGORICAL_FEATURES),
    ('mul_cat_features', OneHotEncoder(drop='first', handle_unknown='ignore', sparse_output=False), MULTI_CATEGORICAL_FEATURES),
